                    ...
                    [
                        ...
                        'children' => [
                            [
                                'name' => '提现申请',
                                'is_menu' => true,
                                'route' => 'mch/princeaccount/account/cash',
                            ],
                            [
                                'name' => '收支明细',
                                'is_menu' => true,
                                'route' => 'mch/princeaccount/account/log',
                            ],
                            [
                                'name' => '收款账户设置',
                                'is_menu' => true,
                                'route' => 'mch/princeaccount/account/setting',
                            ],
                        ],
                    ],
                    [
                        'key' => 'prince_admin_account',
			'name' => '提现管理',
                        //'admin' => true,
                        'is_menu' => true,
                        'route' => '',
				...
				'name' => '提现审批',
                                'is_menu' => true,
                                'route' => 'mch/princeaccount/index/cash',
                            ],
                            [
                                //'admin' => true,
                                'name' => '提现设置',
                                'is_menu' => true,
                                'route' => 'mch/princeaccount/index/setting',
                            ],
                        ],
                    ],    
                    [
                    ...
                    [
                        ...
                        'children' => [
                            [
                                'name' => '普通商品库',
                                'is_menu' => true,
                                'route' => 'mch/princecloud/goods/goods',
                            ],
                            [
                                'name' => '普通分类库',
                                'is_menu' => true,
                                'route' => 'mch/princecloud/cat/index',
                            ],
                            [
                                'name' => '基础设置',
                                'is_menu' => true,
                                'route' => 'mch/princecloud/setting/index',
                            ],
                        ],
                    ]
                ],
			...
			[
                        ...
                        'children' => [
                            [
                                ...
                                'is_menu' => true,
                        	//'admin' => true,
                                'route' => 'mch/princeorder/order/index',
                            ],
                            [
                                'name' => '秒杀订单',
                                'is_menu' => true,
                        	//'admin' => true,
                                'route' => 'mch/princeorder/miaosha/order/index',
                            ],
                            [
                                'name' => '拼团订单',
                                'is_menu' => true,
                        	//'admin' => true,
                                'route' => 'mch/princeorder/group/order/index',
                            ],
                            [
                                'name' => '预约订单',
                                'is_menu' => true,
                            ...
                            [
                                ...
                                'is_menu' => true,
                        		//'admin' => true,
                                'route' => 'mch/princeorder/integralmall/integralmall/order',
                            ],
                            [
                                'name' => '九宫格订单',
                                'is_menu' => true,
                        	//'admin' => true,
                                'route' => 'mch/princeorder/pond/order/index',
                            ],
                            [
                                'name' => '刮刮卡订单',
                                'is_menu' => true,
                        	//'admin' => true,
                                'route' => 'mch/princeorder/scratch/order/index',
                            ],
                            [
                                'name' => '砍价订单',
                                'is_menu' => true,
                    ...
                    [
                        ...
                        'children' => [
                            ...
                            [
                                'name' => '分销商等级',
                                'is_menu' => true,
                                'route' => 'mch/share/level',
                                'sub' => [
                                    [
                                        'name' => '添加分类(S|U)',
                                        'is_menu' => false,
                                        'route' => 'mch/share/level-add',
                                    ],
                                    [
                                        'name' => '修改分类(S|U)',
                                        'is_menu' => false,
                                        'route' => 'mch/share/level-edit',
                                    ]
                                ],
                            ],
                        ]
                    ...
                    [
                        ...
                        'children' => [
                            [
                                'name' => '普通评论采集',
                                'is_menu' => true,
                                'route' => 'mch/prince-comment/collect',
                            ],
                            [
                                'name' => '替换规则',
                                'is_menu' => true,
                                'route' => 'mch/prince-comment/rule-list',
                            ],
                            [
                                'name' => '虚拟用户库',
                                'is_menu' => true,
                                'route' => 'mch/prince-comment/user-list',
                            ],
                            [
                                'name' => '采集设置',
                                'is_menu' => true,
                                'route' => 'mch/prince-comment/setting',
                            ],
                        ],
                    ]
                    //P_ADD END
