...
<div>
    <div class="d-flex p-2">
        <div class="col">积分商城</div>
    </div>
    <div class="p-2 bb-1">
        <div class="d-flex col align-items-center"><span>是否显示优惠券</span></div>
        <label class="radio-label radio-block"
               data-param="is_coupon" data-item="1">
            <input type="radio" name="is_coupon" :checked="item.param.is_coupon == 1 ? true : ''">
            <span class="label-icon"></span>
            <span class="label-text">显示</span>
        </label>
        <label class="radio-label radio-block"
               data-param="is_coupon" data-item="0">
            <input type="radio" name="is_coupon" :checked="item.param.is_coupon == 0 ? true : ''">
            <span class="label-icon"></span>
            <span class="label-text">不显示</span>
        </label>
    </div>
    <template v-if="item.param.is_coupon == 1">
        <div class="d-flex p-2">
        ...
        <div class="d-flex p-2 bb-1">
            <div class="d-flex col-3"><span>背景图</span></div>
    ...
    <div class="p-2 bb-1">
        <div class="d-flex col align-items-center"><span>是否显示商品</span></div>
        <label class="radio-label radio-block"
    ...
    <template v-if="item.param.is_goods == 1">
        <div class="bb-1 p-2">
            ...
            <div class="d-flex flex-wrap banner-one">
                ...
                <div data-key="0" data-type="miaosha"
        ...
        <div class="p-2 bb-1">
            ...
            <div class="d-flex flex-wrap">
                <template v-for="(value,key) in defaultList.goods.list_style"
                          v-if="value.type.indexOf('miaosha') != -1">
                    <label class="radio-label radio-block"
