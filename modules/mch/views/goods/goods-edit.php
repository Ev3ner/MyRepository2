                            ...
                            <div class="step-block" flex="dir:left box:first">
                                ...
                                <div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-3 text-right">
                                            <label class=" col-form-label">淘宝/天猫/京东/1688/拼多多一键采集</label>
                                        </div>
                                        <div class="col-9">
                                            <div class="input-group short-row">
                                            ...
                                            <div class="short-row text-muted fs-sm">
                                                例如：商品链接为:https://item.jd.com/8263412.html
                                                <br />或:http://item.taobao.com/item.htm?id=522155891308
                                                <br />或:http://detail.tmall.com/item.htm?id=522155891308
                                				<br />或：https://detail.1688.com/offer/574766616250.html
                                                <br />或：https://mobile.yangkeduo.com/goods.html?goods_id=978939590
                                            </div>
                                            <div class="short-row text-muted fs-sm">若不使用，则该项为空</div>
                                            <div class="copy-error text-danger fs-sm" hidden></div>
                                        </div>
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    page.checked_attr_list =res.data.type==1?res.data.checked_attr_list:getAttrList();//P_MOD
