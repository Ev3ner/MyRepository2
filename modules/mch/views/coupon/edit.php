    ...
    <div class="panel-body">
        <form class="form auto-form" method="post" autocomplete="off" return="<?= $urlManager->createUrl(['mch/coupon/edit','id' => $model->id]) ?>">
            <div class="form-body">
                ...
                <div class="form-group row">
                    <div class="form-group-label col-3 text-right">
                        <label class=" col-form-label required">使用限制</label>
                    </div>
                    <div class="col-9 pt-1">
                        <label class="checkbox-label">
                            <input name="is_only_first_order" value="1" type="checkbox" class="custom-control-input"
                            <?= $model->is_only_first_order == 1 ? 'checked' : '' ?>>
                            <span class="label-icon"></span>
                            <span class="label-text">仅限新用户首单使用</span>
                        </label>
                    </div>
                </div>
                <div class="form-group row">
