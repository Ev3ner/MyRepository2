        ...
        <div class="mb-3 clearfix">
            <div class="float-left">
                <div class="dropdown float-right ml-2">
                    <a href="javascript:" data-toggle="modal" data-target="#attrAddModal"
                           class="btn btn-primary ">批量采集</a>
        ...
        <table class="table table-bordered bg-white table-hover">
            ...
            <?php foreach ($list as $index => $goods) : ?>
                <tr>
                    ...
                    <td class="nowrap text-danger"><?= $goods->cost_price ?>元</td>
                    <td class="nowrap">
                        <?= $goods->num ?>
                    </td>
                    <!--td class="nowrap">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group mb-3">
                    <div class="input-group short-row">
                         <select class="form-control short-row" name="copy[cat_id]">
                                <option value="0">云端分类（默认）</option>
                                <?php foreach ($new_cat_list as $p) : ?>
                                    <option
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary batch-copy-btn">确定</button>
            </div>
        </div>
    </div>
</div>
