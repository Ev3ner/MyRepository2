            ...
            <tr>
                ...
                <td class="order-tab-2">
                    ...
                    <?php if ($order_item['user_coupon_id']): ?>
                        <div><span class="titleColor">优惠券：</span><span
                    ...
                    <?php if ($order_item['before_update_price']): ?>
                        <?php if ($order_item['pay_price'] > $order_item['before_update_price']): ?>
                            <div><span class="titleColor">后台加价：</span><span
                                        style="color:red;"><?= $order_item['pay_price'] - $order_item['before_update_price'] ?></span>元
                            </div>
                        <?php else: ?>
                            <div><span class="titleColor">后台优惠：</span><span
                    ...
                    <?php if ($order_item['integral'] && $order_item['integral']['forehead_integral']): ?>
                        <div><span class="titleColor">使用<?= $order_item['integral']['forehead_integral'] ?>
                                积分抵扣：</span><span style="color:red;"><?= $order_item['integral']['forehead'] ?></span>元
                        </div>
                    <?php endif; ?>
                    <?php if ($order_item['discount'] && $order_item['discount'] != 10): ?>
                        <div><span class="titleColor">会员折扣：<span
                                        style="color:blue;"></span><?= $order_item['discount'] ?></span>折
                        </div>
                    <?php endif; ?>
                ...
                <td class="order-tab-3">
                    <div class="titleColor"><span style="color:red;"><?= $order_item['pay_price'] ?></span>元</div>
                </td>
                ...
                <td colspan="5">
                    <div>
                        <?php if ($order_item['is_offline'] == 0): ?>
                            ...
                            <span class="mr-2"><span class="titleColor">电话：</span><?= $order_item['mobile'] ?></span>
                        ...
                        <?php if ($order_item['is_send'] == 1): ?>
                            <?php if ($order_item['is_offline'] == 0 || $order_item['express']): ?>
                                <?php if ($order_item['is_offline'] == 0 || $order_item['express']) : ?>
                                    <span><span class="badge badge-default mr-1"><?= $order_item['express'] ?></span><span
                                                class="titleColor">快递单号：</span><a
