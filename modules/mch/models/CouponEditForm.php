...
class CouponEditForm extends MchModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['is_only_first_order'], 'integer', 'min'=>0, 'max'=>1],
    ...
    public function save()
    {
        ...
        $this->coupon->is_only_first_order = intval($this->is_only_first_order);
