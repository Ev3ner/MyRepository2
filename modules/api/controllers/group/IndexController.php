...
class IndexController extends Controller
{
    ...
    public function actionIndex()
    {
       ...
       //     ->all();
        ...
        return new \app\opening\ApiResponse(0, 'success', $data);
    }
    ...
    public function actionGoodList()
    {
        ...
        $ptGoods->user_id = \Yii::$app->user->id;
        $goods = $ptGoods->getList();
        return new \app\opening\ApiResponse(0, 'success', $goods);
    }
    ...
    public function actionGoodDetails($gid = 0)
    {
        ...
        $ptGoods->gid = $gid;
        $ptGoods->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($ptGoods->getInfo());
    }
    /**
     * @param int $gid
     * @return mixed|string
    ...
    public function actionGoodsComment($gid = 0, $page = 0)
    {
        ...
        $ptGoods->page = $page;
        $ptGoods->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($ptGoods->comment());
    }
