...
class IntegralmallController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return new \app\opening\BaseApiResponse($form->index());
    }
    ...
    public function actionExplain()
    {
        ...
        return new \app\opening\BaseApiResponse($form->explain());
    }
    ...
    public function actionExchange()
    {
        ...
        $form->store_id = $this->store_id;
        $form->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($form->exchange());
    }
    ...
    public function actionIntegralDetail()
    {
        ...
        return new \app\opening\BaseApiResponse($form->detail());
    }
    ...
    public function actionCouponInfo()
    {
        ...
        $form->store_id = $this->store_id;
        $form->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($form->couponInfo());
    }
    ...
    public function actionExchangeCoupon()
    {
        ...
        $form->type = $get['type'];
        $form->store_id = $this->store_id;
        return new \app\opening\BaseApiResponse($form->exchangeCoupon());
    }
    ...
    public function actionGoodsList()
    {
        $form = new IntegralForm();
        $form->attributes = \Yii::$app->request->get();
        return new \app\opening\BaseApiResponse($form->getGoodsList());
    }
    ...
    public function actionGoodsInfo()
    {
        ...
        return new \app\opening\BaseApiResponse($form->search());
    }
    ...
    public function actionSubmit()
    {
        ...
        return new \app\opening\BaseApiResponse($form->save());
    }
    ...
    public function actionList()
    {
        ...
        $form->store_id = $this->store->id;
        $form->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($form->orderList());
    }
    ...
    public function actionRevoke()
    {
        ...
        $form->store_id = $this->store->id;
        $form->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($form->revoke());
    }
    ...
    public function actionOrderSubmit()
    {
        ...
        $form->store_id = $this->store->id;
        $form->user = \Yii::$app->user->identity;
        return new \app\opening\BaseApiResponse($form->orderPay());
    }
    ...
    public function actionConfirm()
    {
        ...
        $form->store_id = $this->store->id;
        $form->user_id = \Yii::$app->user->id;
        return new \app\opening\BaseApiResponse($form->confirm());
    }
    ...
    public function actionGetQrcode()
    {
        ...
        $res = $form->getQrcode();
        return new \app\opening\BaseApiResponse($res);
    }
    ...
    public function actionClerkOrderDetails()
    {
        ...
        if (!$order) {
            return new \app\opening\ApiResponse(1, '订单不存在');
        }
        ...
        return new \app\opening\BaseApiResponse($data);
    }
    ...
    public function actionClerk()
    {
        if (\Yii::$app->user->identity->is_clerk != 1) {
            return new \app\opening\ApiResponse(1, '不是核销员禁止核销');
        }
        ...
        if ($integralOrder->is_pay == 0) {
            return new \app\opening\ApiResponse(1, '订单未支付');
        }
        if ($integralOrder->clerk_id != null && $integralOrder->clerk_id != -1) {
            return new \app\opening\ApiResponse(1, '订单已核销');
        }
        ...
        if ($integralOrder->save()) {
            return new \app\opening\ApiResponse(0, '核销完成');
        }
    }
