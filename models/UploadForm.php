...
use Opening\Storage\Drivers\Local;
use Opening\Storage\Helpers\UrlConverter;
use OSS\OssClient;
use Qiniu\Auth;
    ...
    private function setDriver($name = null)
    {
        ...
        switch ($this->upload_config->storage_type) {
            case 'aliyun':
                ...
                $driver = [
                    'class' => 'Opening\Storage\Drivers\Aliyun',
            ...
            case 'qiniu':
                ...
                $driver = [
                    'class' => 'Opening\Storage\Drivers\Qiniu',
                    'accessKey' => $config->access_key,
                    'secretKey' => $config->secret_key,
                    'bucket' => $config->bucket
                ];
            ...
            case 'qcloud':
                ...
                $driver = [
                    'class' => 'Opening\Storage\Drivers\Qcloud',
