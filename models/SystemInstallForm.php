...
class SystemInstallForm extends \yii\base\Model
{
    ...
    {
        if (!$this->validate()) {
            return new \app\opening\ValidationErrorResponse($this->errors);
        }
...
EOF;
        ...
        $db_content = str_replace('xcxmall_', $this->tablePrefix, $db_content);//P_MOD
        try {
...
( 1,   '{$this->admin_username}','{$admin_password}','{$auth_key}','{$access_token}', 0,         0,           0,              '[\"coupon\",\"share\",\"topic\",\"video\",\"copyright\",\"miaosha\",\"pintuan\",\"book\",\"fxhb\",\"mch\",\"integralmall\",\"permission\",\"pond\",\"scratch\",\"bargain\",\"alipay\",\"prince_comment\",\"lottery\",\"step\",\"diy\",\"gwd\"]',' ',       0);";//P_MOD
