...
use Curl\Curl;
use Opening\Express\Exceptions\TrackingException;
use Opening\Express\Trackers\TrackerInterface;
...
class ExpressDetailForm extends Model
{
    ...
    {
        /**@var array $status_map 定义在 Opening\Express\Status */
        $status_map = [
            -1 => '已揽件',
            0 => '已揽件',
            1 => '已发出',
        ...
        /** @var Waybill $wb */
        $wb = \Yii::createObject([
            'class' => 'Opening\Express\Waybill',
            'id' => $this->express_no,
            'express' => $this->transExpressName($this->express),
        ]);

        $tracker_class_list = [
            // 'Opening\Express\Trackers\Kuaidi100',
            'Opening\Express\Trackers\Kuaidiniao',
            'Opening\Express\Trackers\Kuaidiwang',
        ];
        ...
        foreach ($tracker_class_list as $tracker_class) {
            ...
            if ($tracker_class == 'Opening\Express\Trackers\Kuaidiniao') {
