 ...
 * @property integer $is_only_first_order
...
class Coupon extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'discount_type','is_only_first_order', 'expire_type', 'expire_day', 'begin_time', 'end_time', 'addtime', 'type','is_delete', 'total_count', 'is_join', 'sort','appoint_type','is_integral','integral','total_num','user_num','num'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_only_first_order' => '仅新人首单使用：0=否，1=是',
            'min_price' => '最低消费金额',
            'sub_price' => '优惠金额',
            'discount' => '折扣率',
