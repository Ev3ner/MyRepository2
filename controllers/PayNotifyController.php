...
class PayNotifyController extends Controller
{
    ...
    private function autoBecomeShare($user_id, $store_id)
    {
        ...
        // // 分销商等级升级 by xiaoxingan
        // $level = ShareLevel::findOne($share->share_level_id);
        // if($level){
        //     $share_level = ShareLevel::findOne(['>', 'level', $share->share_level_id]);
        //     if($share_level){
        //         if($share_level->ordermoney < $consumption_sum){
